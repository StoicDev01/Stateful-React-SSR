...
async function getBases() : Promise<Array<string> | undefined>{
    ...
    const result = await (await fetch(`${url}/api/bases`, options)).json();
    return result.bases;
}
    ...
    Promise< { characterID : string, character : CharacterData} | undefined>
{
    ...
    const result = await (await fetch(`${url}/api/create/character`, options)).json();
    return result;
}
    ...
    Promise< {patch : object, description : { [key : string] : string[] }} | undefined>
{
    ...
    const result = await (await fetch(`${url}/api/edit/character`, options)).json();
    return result;
}
